<template>
    <div>
    <svg x="0px" y="0px" viewBox="0 0 494.45 494.45" style="enable-background:new 0 0 494.45 494.45;" stroke="white" fill="white">
      <g>
          <g>
              <g>
                  <path stroke="white" d="M395.225,277.325c-6.8,0-13.5-2.6-18.7-7.8c-71.4-71.3-187.4-71.3-258.8,0c-10.3,10.3-27.1,10.3-37.4,0
